...
const Idashboard = () => {
    useEffect(() => {
        document.title = "PhotoHero | iDashboard";
    }, []);
        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-80 h-full bg-[#1E293B] text-base-content">
                    ...
                    <NavLink exact to="/idashboard/iuserhome" className={`text-white text-lg font-bold ${location.pathname === '/idashboard/iuserhome' ? 'active-link' : ''}`}>
                        <li><p><span className='text-blue-400 '> <AiFillHome /></span> User Home</p></li>
                    </NavLink>

                    <NavLink exact to="/idashboard/addclass" className={`text-white text-lg font-bold ${location.pathname === '/idashboard/addclass' ? 'active-link' : ''}`}>
                        <li>
                            <p>
                                <span className='text-green-400'> <AiFillFileAdd></AiFillFileAdd></span> Add Class
                            </p>
                        </li>
                    </NavLink>

                    <NavLink exact to="/idashboard/myclasses" className={`text-white text-lg font-bold ${location.pathname === '/idashboard/myclasses' ? 'active-link' : ''}`}>
                        <li>
                            <p>
                                <span className='text-blue-400'><MdOutlinePendingActions /></span> My Classes
                            </p>
                        </li>
                    </NavLink>
